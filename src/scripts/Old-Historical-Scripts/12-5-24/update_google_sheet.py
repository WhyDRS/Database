...
db_file_path = 'data/test.db'  # Define the path to the database file
...
query = "SELECT Ticker, Exchange, CompanyNameIssuer, CIK FROM test"  # Adjusted to fetch only the required columns
